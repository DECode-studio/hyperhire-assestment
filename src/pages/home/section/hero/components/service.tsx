    ...
    <div className="hidden md:block opacity-0 animate-fade-in duration-[500ms]">
      <div className="flex flex-row flex-wrap mt-14">
        <div className="flex flex-col text-start justify-start w-36">
          ...
          <span className="text-lg font-semibold text-white">평균 월 120만원</span>

          <span className="text-lg font-normal text-white flex flex-col">임금을 해당 국가를 기준 으로 계산합니다.</span>
        </div>

        <div className="flex flex-col text-start justify-start ml-10 w-36">
          <div className="border-b border-white mb-2"></div>

          <span className="text-lg font-semibold text-white">최대 3회 인력교체</span>
        ...
        <div className="flex flex-col text-start justify-start ml-10 w-36   ">
          ...
          <span className="text-lg font-semibold text-white">평균 3일, 최대 10일</span>
